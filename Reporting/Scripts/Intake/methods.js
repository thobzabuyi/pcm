...
$(function () {
    ...
    $("body").on('submit', '#saveCreateVEPServices', function (e) {
        console.log("save VEP service runs here.");
        e.preventDefault();
        CreateVEPServicesDetails();
        //CreateVEPReferalDetails();
    });

    $("body").on('submit', '#saveCreateVEPReferal', function (e) {
        console.log("save VEP referral runs here.");
        e.preventDefault();
        //CreateVEPServicesDetails();
    });
...
function LoadServicesItems(person_Id) {
    $.ajax({
        ...
        success: function (data) {
            console.log('Test number cccccccccc1');
