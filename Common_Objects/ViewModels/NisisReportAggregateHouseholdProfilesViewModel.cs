...
{
    public class NisisReportAggregateHouseholdProfilesViewModel
    {
        ...
        public List<ReportStruct_EANumberBreakdown> ReportData_EANumberBreakdown { get; set; }
        public List<ReportStruct_ServiceCategory> ReportData_ServiceBreakdown { get; set; }
    }

    public class ReportStruct_EANumberBreakdown
    {
        public string EANumber { get; set; }
        public int HouseholdCount { get; set; }
    }

    public class ReportStruct_ServiceCategory
    {
        public string Description { get; set; }
        public List<ReportStruct_ServiceBreakdown> ServiceBreakdown { get; set; }
    }

    public class ReportStruct_ServiceBreakdown
    {
        public string Description { get; set; }
