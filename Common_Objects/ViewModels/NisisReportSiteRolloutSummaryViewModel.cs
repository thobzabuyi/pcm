...
{
    public class NisisReportSiteRolloutSummaryViewModel
    {
        ...
        public List<RowInformation> ReportData { get; set; }
    }

    public class RowInformation
    {
        public string Description { get; set; }
        public int ListedHouseholdsCount { get; set; }
        public int CapturedHouseholdsCount { get; set; }
        public int ServicesReferredCount { get; set; }
        public int ServicesDeliveredCount { get; set; }
    }
}
