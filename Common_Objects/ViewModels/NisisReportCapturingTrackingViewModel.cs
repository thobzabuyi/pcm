...
{
    public class NisisReportCapturingTrackingViewModel
    {
        ...
        public WeekData ThisWeekCountData { get; set; }
        public WeekData LastWeekCountData { get; set; }

        public List<WeekData> ThisWeekCapturerData { get; set; }
        public List<WeekData> LastWeekCapturerData { get; set; }
    }

    public class WeekData
    {
        public string Description { get; set; }
        public List<WeekDay> DayData { get; set; }
