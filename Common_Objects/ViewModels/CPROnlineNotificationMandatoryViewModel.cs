...
{
    public class CPROnlineNotificationMandatoryViewModel
    {
        ...
        public CPR_OnlineNotification_MandatoryReporter Reporter { get; set; }
        ...
        public SelectList Riskindicators
        {
            ...
            {
                var _db = new SDIIS_DatabaseEntities();
                var employers = (from m in _db.Risk_Indicators
                                 select new SelectListItem()
                                 {
                                     Text = m.Description,
                                     Value = m.Risk_Indicator_Id.ToString(),
                                     Selected = m.Risk_Indicator_Id.Equals(SelectedRiskIndicator_Id)
                                 }).ToList();

                var selectList = new SelectList(employers, "Value", "Text", SelectedRiskIndicator_Id);
