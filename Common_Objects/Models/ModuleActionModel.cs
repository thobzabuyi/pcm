...
namespace Common_Objects.Models
{
    public class ModuleActionModel
    {
        ...
        public List<Module_Action> GetListOfModuleActions(bool showInActive, bool showDeleted, string SearchActionName, string SearchControllerName, string SearchModule)
        {
            var dbContext = new SDIIS_DatabaseEntities();
            ...
            try
            {
                ...
                if (SearchActionName != null || SearchControllerName != null || SearchModule != null)
                {
                    moduleActionsList = (from ma in dbContext.Module_Actions
                                         where ma.Module_Action_Name.Contains(SearchActionName)
                                         where ma.Module_Controller.Module_Controller_Name.Contains(SearchControllerName)
                                         where ma.Module_Controller.Module.Description.Contains(SearchModule)
                                         select ma).ToList();
                }
