...
namespace Common_Objects.Models
{
    public class PersonModel
    {
        ...
        public Person CPRAddAddress(int personId, int addressTypeId, string addressLine1, string addressLine2, int? localMunicipalityId,int? townId, string postalCode)
        {
            Person editPerson;
